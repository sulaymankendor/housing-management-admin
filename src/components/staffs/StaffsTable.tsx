...
export default function StaffsTable() {
  return (
    <div className="relative w-full mx-auto mt-10 ">
      <div className="flex justify-between items-center border-t border-x border-gray-200 p-5 rounded-t-2xl">
        <div>
          <h1 className="font-semibold text-lg text-gray-800">Staffs</h1>
      ...
      <div className="overflow-x-auto rounded-b-2xl border border-gray-200 py-7">
        <Table
          ...
          >
            {[...Array(7)].map((driver: any, index) => (
              <TableRow key={index}>
                ...
                <TableCell className="whitespace-nowrap py-5 pl-4 pr-3 sm:pl-0 text-center min-w-[140px] text-gray-500 text-xs">
                  2024-03-10
                </TableCell>
                {/* <TableCell className="min-w-[140px] text-center text-gray-500 text-sm">
                  +1 234-567-8900
                </TableCell> */}
